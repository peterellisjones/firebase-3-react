/*
  SOURCE: https://github.com/angular/angularfire2/blob/master/manual_typings/firebase3/firebase3.d.ts
*/
...
declare namespace firebase.database {
  interface Query {
    ...
    once(eventType: string, callback?: (a: firebase.database.DataSnapshot, b?: string) => any, cancelCallbackOrContext?: Object, context?: Object): firebase.Promise<any>;
